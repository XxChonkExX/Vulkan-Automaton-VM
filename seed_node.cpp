...
int main() {
    ...
    // Setup MultiNodePoolManager as seed
    ...
    // Listen on all interfaces, port 51001
    vvm::network::NetworkConfig netCfg;
    netCfg.listenAddress = "0.0.0.0:51001";
    netCfg.seedNodes = {};  // Empty = bootstrap/seed node
